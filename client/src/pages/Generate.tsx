          ...
          <div className="grid lg:grid-cols-[400px_1fr] gap-8">
            ...
            <div className={`space-y-6 ${id && 'pointer-events-none'}`}>
              <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                <div>
                  <h2 className="text-xl font-bold text-zinc-100 mb-1">Create Yor Thumbnail</h2>
                  <p className="text-sm text-zinc-400">Describe your vision and let AI bring it to file</p>
                </div>
                <div className="space-y-5">
                  ...
                  <AspectRatioSection value={aspectRatios} onChange={setAspectRatio}/>
                  {/*style selector*/}
