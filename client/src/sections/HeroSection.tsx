...
export default function HeroSection() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            text-pink-100 bg-pink-200/15 cursor-pointer
            hover:bg-pink-600 hover:text-white hover:px-7 hover:h-11 transition-all duration-300"
            ...
            >
                ...
                group-hover:bg-white group-hover:text-pink-600 transition-all duration-300">
                    NEW
                </span>
            ...
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >Stop wasting hours on design . Get high-converting thubnails in seconds with our advance AI.</motion.p>
